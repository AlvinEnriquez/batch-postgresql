...
import com.alvin.batch_postgresql.student.StudentRepository;
import lombok.RequiredArgsConstructor;

@SpringBootApplication
@Configuration
@RequiredArgsConstructor
@ComponentScan(basePackages = "com.alvin.batch_postgresql")
public class BatchConfig {
	...
	public FlatFileItemReader <Student> itemReader() {
		...
		//itemReader.setResource(new  FileSystemResource ("/batch-postgresql/src/main/resources/student.csv"));
